...
(function() {
  ...
  Agility.Collection = (function(_super) {
    ...
    function Collection() {
      ...
      this.isFetched = __bind(this.isFetched, this);
      this._handleFetch = __bind(this._handleFetch, this);
    ...
    Collection.prototype.initialize = function(options) {
      ...
      this._fetched = false;
      return this.listenTo(this, "fetch", this._handleFetch);
    };

    Collection.prototype._handleFetch = function() {
      return this._fetched = true;
    };

    Collection.prototype.isFetched = function() {
  ...
  Agility.Model = (function(_super) {
    ...
    function Model() {
      ...
      Model.__super__.constructor.apply(this, options);
  ...
  Agility.Router = (function() {
    ...
    Router.prototype.route = function(path, action) {
      return this.router.route(path, action, (function(_this) {
        return function() {
          var params;
  ...
  Agility.View = (function(_super) {
    ...
    View.prototype.view = function(viewClassName, options) {
      var view, viewClass;
