...
(function() {
  var Agility, App, root, _ref, _ref1,
  ...
  Agility.Application = (function() {
    ...
    function Application() {
      ...
      this.bindNotFound = __bind(this.bindNotFound, this);      this.router = new Agility.Router(this);
    }
  ...
  Agility.Router = (function() {
    function Router(app) {
      ...
      this.route = __bind(this.route, this);      this.router = new Backbone.Router;
      this.app = app;
    }
    ...
    Router.prototype.dispatch = function(action, params) {
      var controller, instance, method, _ref2;

      this.trigger("route", action);
      _ref2 = action.split("#"), controller = _ref2[0], method = _ref2[1];
